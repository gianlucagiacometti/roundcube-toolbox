...
==============================
This plugin is a set of tools for [Roundcube webmail](https://github.com/roundcube/roundcubemail) and [PostfixAdmin](https://github.com/postfixadmin/postfixadmin) / Postfix with sql backend 
